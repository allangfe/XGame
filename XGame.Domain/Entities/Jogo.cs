    ...
    public class Jogo : EntityBase
    {
        ...
        private void ValidarEntidade()
        {
            new AddNotifications<Jogo>(this)
                            .IfNullOrInvalidLength(x => x.Nome, 1, 100, Mensagens.X0_E_OBRIGATORIO_E_DEVE_CONTER_ENTRE_X1_E_X2_CARACTERES.ToFormat("Nome", "1", "100"))
                            .IfNullOrInvalidLength(x => x.Descricao, 1, 255, Mensagens.X0_E_OBRIGATORIO_E_DEVE_CONTER_ENTRE_X1_E_X2_CARACTERES.ToFormat("Descrição", "1", "255"))
                            .IfNullOrInvalidLength(x => x.Genero, 1, 30, Mensagens.X0_E_OBRIGATORIO_E_DEVE_CONTER_ENTRE_X1_E_X2_CARACTERES.ToFormat("Genero", "1", "30"));
        }
